    ...
    return (
      <Html lang={config.dateLocale} className="relative scroll-smooth antialiased">
        <Head>
          ...
          <link rel="icon" sizes="180x180" href="/favicon-5.png" />
          <link rel="icon" type="image/png" sizes="32x32" href="/favicon-5.png" />
          <link rel="icon" type="image/png" sizes="16x16" href="/favicon-5.png" />
